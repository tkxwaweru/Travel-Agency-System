  ...
  <div class="container">
    <nav>
      ...
      <div class="side_navbar">
        ...
        <a class="active" href="make-booking.php?client">Make Booking</a>
        ...
        <div class="table">
            <table>
                ...
                <?php
                  ...
                  $sql = "SELECT clients.client_code, clients.client_fname, clients.client_lname, clients.national_id, clients.age, clients.sex, clients.phone_number, clients.phone_number, clients.client_email FROM clients WHERE clients.client_code = '$client_code'";
