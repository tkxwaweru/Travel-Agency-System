  ...
  <body>
    <div class="header-container">
      <nav>
        ...
        <ul>
          <li><a href="../Index/index2.php">HOME</a></li>
          <li><a href="../Client-Interfaces/client-dashboard-home.php">DASHBOARD</a></li>
    ...
    <div class="heading">
    <h1>Share your experiences with the rest of Kenya</h1>
    <p>Here are some moments captured by our satisfied customers. Login to share your own moments</p>
    </div>
